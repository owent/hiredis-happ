...
description: "Use when: updating AGENTS.md, CLAUDE.md, Copilot shims, Agent Skills, source indexes, or cross-tool AI configuration for hiredis-happ."
---
...
- `CLAUDE.md` is a thin compatibility shim importing `AGENTS.md`.
...
1. Inventory existing files: `AGENTS.md`, `CLAUDE.md`, `.agents/skills/`, `.github/copilot-instructions.md`, `.github/copilot/skills/`, `.github/instructions/`, `.github/prompts/`, `.github/agents/`.
...
- Avoid duplicating identical instructions across `AGENTS.md`, `CLAUDE.md`, Copilot shims, and skills.
